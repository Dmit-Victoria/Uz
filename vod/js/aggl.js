...
// 网站主页
const webSite = 'https://www.fsdm02.com'
// 网站搜索
// https://www.fsdm02.com/search/海----------2---/
const searchUrl = '@{webSite}/search/@{searchWord}----------@{page}---'
// 当前网站任意视频详情页
// https://www.fsdm02.com/GV26152/
const videoDetailPage = '@{webSite}/GV26152/'
// 当前网站任意视频播放页
// https://www.fsdm02.com/playGV26152-1-1/
...
const firstClass = [
    {
        ...
        subClass: [
            {
                name: '全部',
                // https://www.fsdm02.com/show/2--------2---
                // 把网站主页变成 @{webSite}  把页码变成 @{page}
                id: '@{webSite}/show/2--------@{page}---',
            },
            {
                name: '喜剧',
                // https://www.fsdm02.com/show/2---喜剧-----2---
                // 把网站主页变成 @{webSite}  把页码变成 @{page}
    ...
    },
    {
        ...
        subClass: [
            {
                // https://www.fsdm02.com/21--------2---/
                name: '全部',
                id: '@{webSite}/show/21--------@{page}---',
            },
            {
                // https://www.fsdm02.com/21---喜剧-----2---/
                name: '喜剧',
